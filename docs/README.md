...
- 🔄 **Phase 2 (진행 중)** — 웨이브 단위.
  ...
  - ✅ Wave 1c: 시드 3개 딥 — 정보처리산업기사(C1)·한국사(C3)·TOEIC(C4) 2026 검증·인용·퀘스트 경로.
  - ✅ Wave 2: 신규 기회 **10개** breadth 발굴·검증·병합(Sonnet 에이전트 4 → Opus 큐레이션) → E4 해군창업·E5 공군창업·E6 국방AI경연·C10 SW·AI·C11 운전면허·C12 지게차/굴착기·C13 검정고시·M4 청년미래적금·T2 내일배움카드·T3 보훈부. 공군 해커톤·국방헬프콜은 E3·MI2 실예시로 병합. 포상휴가 법령 근거(시행령 §13)를 [10](./10-honesty-notes.md)에 추가.

> **Phase 2 완료.** 원본 단일 문서는 루트의 `PRODUCT_OVERVIEW.md` 에 그대로 보존되어 있다(레거시/diff 참고용).
